      ...
      <Container>
        <div className='mx-auto max-w-2xl md:text-center'>
          ...
          <p className='mt-4 text-lg tracking-tight text-slate-700'>
            Our software is so simple that people can’t help but fall in love with it. Simplicity is easy when you just skip tons of mission-critical
            features.
          </p>
        </div>
                    ...
                    <figure className='relative rounded-2xl bg-white p-6 shadow-xl shadow-slate-900/10'>
                      ...
                      <figcaption className='relative mt-6 flex items-center justify-between border-t border-slate-100 pt-6'>
                        ...
                        <div className='overflow-hidden rounded-full bg-slate-50'>
                          <Image className='h-14 w-14 object-cover' src={testimonial.author.image} alt='' width={56} height={56} />
                        </div>
                      </figcaption>
                    </figure>
                  </li>
